...
data_arg.add_argument(
    "--dataset", type=str, default='Mnist', help="Dataset" # Mnist, Fashion, Cifar10
)
data_arg.add_argument(
    "--memory_type", type=str, default='lstm'
)
data_arg.add_argument(
    "--glimpse_list", type=list, default= [2,3,4,5,6,7,8,9,10] # 2,3,4,5,6,7,8,9,10
)
data_arg.add_argument(
    "--num_workers",
    type=int,
...
train_arg.add_argument(
    "--epochs", type=int, default=500, help="# of epochs to train for"
)
train_arg.add_argument(
...
misc_arg.add_argument(
    "--random_seed", type=int, default=False, help="Seed to ensure reproducibility"
)
misc_arg.add_argument(
