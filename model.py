...
class RecurrentAttention(nn.Module):
    ...
    def __init__(
        self, g, k, s, c, h_g, h_l, std, hidden_size, num_classes, memory_type
    ):
        """Constructor.
        ...
        self.rnn = modules.CoreNetwork(hidden_size, hidden_size, memory_type)
    ...
    def forward(self, x, l_t_prev, h_t_prev, c_t, last=False):
        ...
        h_t, c_t = self.rnn(g_t, h_t_prev, c_t)
        ...
        if last:
            ...
            return h_t, l_t, b_t, log_probas, log_pi, c_t

        return h_t, l_t, b_t, log_pi, c_t
